...
* 2020/9/27 일
  * Hacktoberfest : 갑자기 필 받아서 Hacktoberfest 한국어 웹사이드 만들고 페북 그룹 만들었다.....
    * www.hacktoberfestkorea.com 도메인 구매
    * github에 저장소 만들고 도메인 연결
    * 페이스북에 Hacktoberfest Korea 그룹 만들었다.
    * 인터넷에 후기 남긴 사이트들 찾아서 메일보냄
    
* 2020/9/25 금
  * AWS S3로 회사용 사이트를 호스팅하고 Route53으로 도메인 구입하여 연결 완료
    * 버킷이름을 사이트이름으로 해야만 한다는 점이 중요!
    * '권한'설정해야한다. 안하면 파일업로드할때마다 퍼블릭설정해야됨. 참고:https://nykim.work/25
* 2020/9/22 화
